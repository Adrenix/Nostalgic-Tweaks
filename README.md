# Nostalgic Tweaks - 1.20 (v2) Development Branch
### Forge & Fabric
This is the 1.20 (v2) development branch for N.T.
Initial 1.20 port-forward from 1.19.4 courtesy of [forkiesassds](https://github.com/forkiesassds/Nostalgic-Tweaks/tree/1.20). 
...
- [1.19.4](https://github.com/Adrenix/Nostalgic-Tweaks/tree/1.19.4)
...
`mc-version+mod-loader+mod-version`. An example version number would be `1.20+fabric+2.0.0`.
...
Where `<version>` is replaced by an appropriate version number found on [Modrinth](https://modrinth.com/mod/nostalgic-tweaks/versions).
Ensure you are using a **version number** and not a *version display name*. A version number is formatted as
`mc-version+mod-loader+mod-version`. An example version number would be `1.20+forge+2.0.0`.
