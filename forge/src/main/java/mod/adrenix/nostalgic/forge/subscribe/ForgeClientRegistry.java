...
public abstract class ForgeClientRegistry
{
    /* Configuration Key */
    public static final KeyMapping OPEN_CONFIG = ClientKeyMapping.getConfigKey();

    /* Toggle Fog key */
    public static final KeyMapping TOGGLE_FOG = ClientKeyMapping.getFogKey();
    ...
    public static void init(FMLClientSetupEvent event)
    {
        ...
        ModLoadingContext.get().registerExtensionPoint(ConfigGuiHandler.ConfigGuiFactory.class, () ->
            new ConfigGuiHandler.ConfigGuiFactory(((minecraft, screen) -> new SettingsScreen(screen, false)))
        );
