...
import mod.adrenix.nostalgic.forge.register.ClientRegistration;
...
/**
 * The mod's main class for Forge. This is accessed by both the client and server. Any immediate registration or field
 * definitions are done here.
 */
...
public class NostalgicForge
{
    ...
    public NostalgicForge()
    {
        ...
        if (FMLLoader.getDist().isDedicatedServer())
            ...
            bus.addListener(ClientRegistration::init);
    }
}
