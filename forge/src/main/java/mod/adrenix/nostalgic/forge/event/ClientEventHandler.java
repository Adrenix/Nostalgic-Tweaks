...
public abstract class ClientEventHandler
{
     ...
     */
    @SubscribeEvent
    public static void onLogOut(ClientPlayerNetworkEvent.LoggedOutEvent event) { ClientEventHelper.disconnect(); }
     ...
     */
    @SubscribeEvent
    public static void onSetScreen(ScreenOpenEvent event) { CandyEvents.classicTitleScreens(event); }
     ...
     */
    @SubscribeEvent
    public static void onRenderFog(EntityViewRenderEvent.RenderFogEvent event) { CandyEvents.renderOldFog(event); }
    ...
    public static void onPreRenderOverlay(RenderGameOverlayEvent.PreLayer event) { GuiEvents.overlayOverride(event); }
}
