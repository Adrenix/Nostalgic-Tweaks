...
public class MixinEmbeddiumPlugin implements IMixinConfigPlugin
{
    ...
    {
        boolean isEmbeddium = FMLLoader.getLoadingModList().getModFileById("embeddium") != null;
        boolean isRubidium = FMLLoader.getLoadingModList().getModFileById("rubidium") != null;

        return isEmbeddium || isRubidium;
    }
