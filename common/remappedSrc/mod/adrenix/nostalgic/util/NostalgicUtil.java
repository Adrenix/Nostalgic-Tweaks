...
public abstract class NostalgicUtil
{
    ...
    {
        public static final Identifier BLACK_RESOURCE = new Identifier(NostalgicTweaks.MOD_ID + ":textures/black.png");
        public static final Identifier GEAR_LOGO = new Identifier(NostalgicTweaks.MOD_ID + ":textures/gear.png");
        public static final Identifier WIDGETS_LOCATION = new Identifier(NostalgicTweaks.MOD_ID + ":textures/gui/widgets.png");
        public static final Identifier COLOR_PICKER = new Identifier(NostalgicTweaks.MOD_ID + ":textures/gui/overlay_picker.png");
        public static final Identifier CATEGORY_LIST = new Identifier(NostalgicTweaks.MOD_ID + ":textures/gui/overlay_list.png");
        public static final Identifier MOJANG_ALPHA = new Identifier(NostalgicTweaks.MOD_ID + ":textures/gui/mojang_alpha.png");
        public static final Identifier MOJANG_BETA = new Identifier(NostalgicTweaks.MOD_ID + ":textures/gui/mojang_beta.png");
        public static final Identifier MOJANG_RELEASE_ORANGE = new Identifier(NostalgicTweaks.MOD_ID + ":textures/gui/mojang_release_orange.png");
        public static final Identifier MOJANG_RELEASE_BLACK = new Identifier(NostalgicTweaks.MOD_ID + ":textures/gui/mojang_release_black.png");
        public static final Identifier MINECRAFT_LOGO = new Identifier("textures/gui/title/minecraft.png");
    }
    ...
    public static class Text
    {
        ...
        /**
         * Combine multiple Minecraft {@link net.minecraft.text.Text Components} into one single component.
         * @param lines An array of {@link net.minecraft.text.Text Components}.
         * @return One single {@link net.minecraft.text.Text}
         */
        public static net.minecraft.text.Text combine(net.minecraft.text.Text[] lines)
        {
            StringBuilder builder = new StringBuilder();
            for (net.minecraft.text.Text component : lines) builder.append(component.getString()).append("\n\n");
            return net.minecraft.text.Text.literal(builder.toString());
        }
    }
    ...
    {
        /**
         * Text wrap a Minecraft {@link net.minecraft.text.Text} into an array of multiple {@link net.minecraft.text.Text Components}
         * with the given width.
         * @param translation A {@link net.minecraft.text.Text}.
         * @param width How long each line should be.
         * @return An array of {@link net.minecraft.text.Text Components}.
         */
        public static List<net.minecraft.text.Text> tooltip(net.minecraft.text.Text translation, int width)
        {
            String translated = translation.getString();
            ArrayList<String> lines = wrap(translated, width);

            List<net.minecraft.text.Text> components = new ArrayList<>();
            lines.forEach((line) -> components.add(net.minecraft.text.Text.literal(line)));
