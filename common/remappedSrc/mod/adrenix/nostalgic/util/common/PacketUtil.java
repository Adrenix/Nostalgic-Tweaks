...
public abstract class PacketUtil
{
     ...
     */
    public static <Packet> void sendToPlayer(ServerPlayerEntity player, Packet packet)
    {
     ...
     * @param <Packet> A packet class.
     */
    public static <Packet> void sendToAll(Iterable<ServerPlayerEntity> players, Packet packet)
    {
    ...
    public static <Packet> void sendToAll(Packet packet) throws AssertionError
    {
        ...
        sendToAll(server.getPlayerManager().getPlayerList(), packet);
    }
