...
public abstract class LevelRendererMixin
{
    ...
    private void NT$onCacheSkyPose(PoseStack poseStack, Matrix4f projectionMatrix, float partialTick, Runnable skyFogSetup, CallbackInfo callback)
    {
    ...
    private void NT$onDrawSkyBuffer(PoseStack poseStack, Matrix4f projectionMatrix, float partialTick, Runnable skyFogSetup, CallbackInfo callback)
    {
