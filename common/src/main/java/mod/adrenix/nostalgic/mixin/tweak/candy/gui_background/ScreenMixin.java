...
public abstract class ScreenMixin
{
    ...
    private void nt_gui_background$wrapBackgroundRenderer(GuiGraphics graphics, int x1, int y1, int x2, int y2, int colorFrom, int colorTo, Operation<Void> operation)
    {
        ...
        else if (CandyTweak.OLD_GUI_BACKGROUND.get() != GuiBackground.SOLID_BLACK)
        {
            ...
            operation.call(graphics, x1, y1, x2, y2, colorFrom, colorTo);
    }
}
