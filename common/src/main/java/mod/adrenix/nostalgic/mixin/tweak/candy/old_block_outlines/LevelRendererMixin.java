...
public abstract class LevelRendererMixin
{
    ...
    private void NT$setCustomBlockOutlines(PoseStack poseStack, VertexConsumer consumer, VoxelShape shape, double x, double y, double z, float r, float g, float b, float a, Operation<Void> vanilla, PoseStack arg1, VertexConsumer arg2, Entity arg3, double arg4, double arg5, double arg6, BlockPos arg7, BlockState state)
    {
