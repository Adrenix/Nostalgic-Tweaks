...
public abstract class TweakCommonCache
{
    ...
    public String getTooltipTranslation() { return ComponentBackport.translatable(this.getTooltipKey()).getString(); }
    public Component getComponentTranslation() { return ComponentBackport.translatable(this.getLangKey()); }
}
