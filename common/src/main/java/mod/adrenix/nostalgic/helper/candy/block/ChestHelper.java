...
public abstract class ChestHelper
{
     ...
     * ensure the cache can be accessed by any thread. The bit set has the zeroth index being whether the block is an
     * old chest and the first index being whether the chest block is translucent.
     */
