...
public abstract class KeyUtil
{
    ...
    public static void onToggleFog(KeyMapping toggleFog)
    {
        ...
        {
            int distance = minecraft.options.renderDistance;

            if (distance >= 16)
                minecraft.options.renderDistance = 8;
            else if (distance >= 8)
                minecraft.options.renderDistance = 4;
            else if (distance >= 4)
                minecraft.options.renderDistance = 2;
            else if (distance >= 2)
                minecraft.options.renderDistance = 16;
