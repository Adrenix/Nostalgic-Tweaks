...
public class ClientConfig implements ConfigMeta
{
    ...
    public static class Sound
    {
        ...
        public boolean oldCaveSounds = SoundTweak.OLD_CAVE_SOUNDS.register("oldCaveSounds");
    ...
    public static class EyeCandy
    {
        ...
        public boolean blinkHeartsOnInstantEat = CandyTweak.BLINK_HEARTS_ON_INSTANT_EAT.register("blinkHeartsOnInstantEat");
        ...
        public boolean applyGuiColorBackground = CandyTweak.APPLY_GUI_COLOR_BACKGROUND.register("applyGuiColorBackground");
    ...
    public static class Gameplay
    {
        ...
        public boolean ignoreAnimalBiomeRestrictions = GameplayTweak.IGNORE_ANIMAL_BIOME_RESTRICTIONS.register("ignoreAnimalBiomeRestrictions");
    ...
    public static class Animation
    {
        ...
        public int verticalBobbingIntensity = AnimationTweak.VERTICAL_BOBBING_INTENSITY.register("verticalBobbingIntensity");
