...
public abstract class NostalgicTweaks
{
    ...
    /**
     * Getter method for checking if the mod is running on (Neo)Forge.
     *
     * @return Whether the mod is loaded by a (Neo)Forge loader.
     */
     ...
     */
    public static final String PROTOCOL = "2.2";
