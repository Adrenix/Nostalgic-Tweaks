...
public class RadioGroup<E extends Enum<E>> extends AbstractWidget
{
    ...
    {
        super(ConfigRowList.TEXT_START, 0, 0, ConfigRowList.BUTTON_HEIGHT, ComponentBackport.empty());
    ...
    private static class Radio<E extends Enum<E>> extends AbstractWidget
    {
        ...
        {
            super(ConfigRowList.TEXT_START, 0, ConfigRowList.BUTTON_HEIGHT, ConfigRowList.BUTTON_HEIGHT, ComponentBackport.empty());
        ...
        public void render(PoseStack poseStack, int mouseX, int mouseY, float partialTick)
        {
            ...
            Component defaultText = ComponentBackport.literal(this.isDefault() ? String.format(" (%s)", ComponentBackport.translatable(LangUtil.Gui.DEFAULT).getString()) : "");
            Component optionText = ComponentBackport.literal(this.label.apply(this.value).getString() + defaultText.getString());
