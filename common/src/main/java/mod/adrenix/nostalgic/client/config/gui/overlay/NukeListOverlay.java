...
public class NukeListOverlay extends ListScreenOverlay<NukeListOverlay.WidgetProvider>
{
    ...
    {
        super(ComponentBackport.translatable(LangUtil.Gui.OVERLAY_NUKE), OVERLAY_WIDTH, OVERLAY_HEIGHT);
    ...
    protected class WidgetProvider extends AbstractWidgetProvider
    {
        ...
        {
            String header = ComponentBackport.translatable(LangUtil.Gui.OVERLAY_NUKE_HEADER).getString();
        ...
        private TextWidget createMessageText()
        {
            return new TextWidget
            (
                ComponentBackport.translatable(LangUtil.Gui.OVERLAY_NUKE_MESSAGE),
                TextAlign.LEFT,
                this.getStartX(),
        ...
        private Button createConfirmYes()
        {
            ...
            (
                ...
                ComponentBackport.translatable(LangUtil.Gui.BUTTON_YES),
                (button) ->
                {
                    Overlay.close();
        ...
        private Button createConfirmNo()
        {
            ...
            (
                ...
                this.getButtonWidth(),
                SettingsScreen.BUTTON_HEIGHT,
                ComponentBackport.translatable(LangUtil.Gui.BUTTON_NO),
