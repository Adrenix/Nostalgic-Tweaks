...
public class CustomizeScreen extends SettingsScreen
{
    ...
    {
        super(parent, new TranslatableComponent(NostalgicLang.Gui.CUSTOMIZE), false);

        this.parent = parent;
        this.undo = Maps.newHashMap(config.custom);

        int x = 2, y = TOP_ROW_Y, w = CHECKBOX_W, h = CHECKBOX_H;
        this.toolsCheckbox = new ToggleCheckbox(this, x, y + 27, w, h, new TranslatableComponent(NostalgicLang.Gui.CUSTOMIZE_TOOL), true);
        this.blocksCheckbox = new ToggleCheckbox(this, x, y + 52, w, h, new TranslatableComponent(NostalgicLang.Gui.CUSTOMIZE_BLOCK), true);
        this.itemsCheckbox = new ToggleCheckbox(this, x, y + 77, w, h, new TranslatableComponent(NostalgicLang.Gui.CUSTOMIZE_ITEM), true);
        this.resetCheckbox = new ToggleCheckbox(this, x, y - 1, w, h, new TranslatableComponent(NostalgicLang.Gui.CUSTOMIZE_RESET), false);
    }
    ...
    {
        Component message = new TranslatableComponent(NostalgicLang.Gui.CUSTOMIZE_ADD).withStyle(ChatFormatting.WHITE);
    ...
    private class WidgetProvider
    {
        ...
        {
            Component tooltip = new TranslatableComponent(NostalgicLang.Gui.CUSTOMIZE_ADD_TOOLTIP).withStyle(ChatFormatting.GREEN);
            return new Button(
        ...
        {
            Component tooltip = new TranslatableComponent(NostalgicLang.Gui.CUSTOMIZE_AUTOFILL_TOOLTIP).withStyle(ChatFormatting.YELLOW);
            return new Button(
        ...
        public Button createResetButton()
        {
            List<Component> tooltip = Lists.newArrayList(
                new TranslatableComponent(NostalgicLang.Gui.CUSTOMIZE_RESET_TOOLTIP_0).withStyle(ChatFormatting.RED),
                new TranslatableComponent(NostalgicLang.Gui.CUSTOMIZE_RESET_TOOLTIP_1).withStyle(ChatFormatting.WHITE)
            );
