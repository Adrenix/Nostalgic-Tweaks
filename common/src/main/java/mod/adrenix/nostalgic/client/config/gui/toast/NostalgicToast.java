...
public class NostalgicToast implements Toast
{
    ...
    private void setup()
    {
        ...
        {
            case WELCOME -> ComponentBackport.translatable(LangUtil.Gui.TOAST_WELCOME_TITLE);
            case HANDSHAKE -> ComponentBackport.translatable(LangUtil.Gui.TOAST_HANDSHAKE_TITLE);
            case TWEAK_C2S -> ComponentBackport.translatable(LangUtil.Gui.TOAST_TWEAK_C2S_TITLE);
            case TWEAK_S2C -> ComponentBackport.translatable(LangUtil.Gui.TOAST_TWEAK_S2C_TITLE);
        };
        ...
        {
            case WELCOME -> ComponentBackport.translatable(LangUtil.Gui.TOAST_WELCOME_MESSAGE, client);
            case HANDSHAKE -> ComponentBackport.translatable(LangUtil.Gui.TOAST_HANDSHAKE_MESSAGE, server, loader);
            case TWEAK_C2S -> ComponentBackport.translatable(LangUtil.Gui.TOAST_TWEAK_C2S_MESSAGE);
            case TWEAK_S2C -> ComponentBackport.translatable(LangUtil.Gui.TOAST_TWEAK_S2C_MESSAGE);
        };
