...
public class ManageItemOverlay extends ListScreenOverlay<ManageItemOverlay.WidgetProvider>
{
    ...
    {
        super(ComponentBackport.translatable(LangUtil.Gui.OVERLAY_ITEM), OVERLAY_WIDTH, OVERLAY_HEIGHT);
    ...
    protected class WidgetProvider extends AbstractWidgetProvider
    {
        ...
        public Button createAddButton()
        {
            ...
            (
                ...
                ComponentBackport.translatable(LangUtil.Gui.OVERLAY_ITEM_ADD),
                (button) ->
                {
                    Overlay.close();
        ...
        public Button createEditButton()
        {
            ...
            (
                ...
                this.getButtonWidth(),
                SettingsScreen.BUTTON_HEIGHT,
                ComponentBackport.translatable(LangUtil.Gui.OVERLAY_ITEM_EDIT),
                (button) ->
                {
                    Overlay.close();
        ...
        public Button createRemoveButton()
        {
            ...
            (
                ...
                this.getButtonWidth(),
                SettingsScreen.BUTTON_HEIGHT,
                ComponentBackport.translatable(LangUtil.Gui.OVERLAY_ITEM_REMOVE),
                (button) ->
                {
                    Overlay.close();
