...
public class TextGroup extends AbstractWidget
{
    ...
    {
        super(ConfigRowList.TEXT_START, 0, list.screen.width - ConfigRowList.TEXT_START - ConfigRowList.TEXT_FROM_END, 12, TextComponent.EMPTY);
    ...
    public class TextRow extends AbstractWidget
    {
        ...
        {
            super(ConfigRowList.TEXT_START, 0, TextGroup.this.width, ConfigRowList.BUTTON_HEIGHT, TextComponent.EMPTY);
