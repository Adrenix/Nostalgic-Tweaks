...
import mod.adrenix.nostalgic.client.gui.screen.config.overlay.listing.MobListingOverlay;
...
public class MobMapOverlay<V> extends MobListingOverlay<V, MobMap<V>> implements DeletableMapOverlay<V, MobMap<V>>
{
    /* Fields */

    private final TweakListing<V, MobMap<V>> tweak;

    /* Constructor */

    public MobMapOverlay(TweakListing<V, MobMap<V>> tweak)
    {
        super(tweak);
