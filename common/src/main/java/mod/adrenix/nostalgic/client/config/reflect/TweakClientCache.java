...
public class TweakClientCache<T> extends TweakCommonCache
{
    ...
    public String getContainerTranslation()
    {
        if (this.category != null)
            return ComponentBackport.translatable(this.category.container().getLangKey()).getString();
        else if (this.subcategory != null)
            return ComponentBackport.translatable(this.subcategory.container().getLangKey()).getString();
        else if (this.embed != null)
            return ComponentBackport.translatable(this.embed.container().getLangKey()).getString();
