...
public class KeyBindButton extends ControlButton
{
    ...
    {
        super(ComponentBackport.empty(), KeyBindButton::edit);
    ...
    private void renderTags(PoseStack poseStack, int mouseX, int mouseY)
    {
        ...
        Component title = ComponentBackport.translatable(this.mapping.getName());
        Component syncTag = ComponentBackport.translatable(LangUtil.Gui.TAG_SYNC);
        Component syncTooltip = ComponentBackport.translatable(LangUtil.Gui.TAG_SYNC_TOOLTIP);
        Component autoTag = ComponentBackport.translatable(LangUtil.Gui.TAG_AUTO);
        Component autoTooltip = ComponentBackport.translatable(LangUtil.Gui.TAG_AUTO_TOOLTIP);
    ...
    public void renderButton(PoseStack poseStack, int mouseX, int mouseY, float partialTick)
    {
        ...
        if (this.isModifying)
        {
            ...
            this.setMessage(ComponentBackport.translatable(LangUtil.Key.UNBOUND).withStyle(ChatFormatting.RED).withStyle(ChatFormatting.ITALIC));
