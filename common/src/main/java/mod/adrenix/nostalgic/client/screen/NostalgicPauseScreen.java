...
public class NostalgicPauseScreen extends PauseScreen
{
    ...
    private final Component mods = ComponentBackport.translatable(LangUtil.Gui.CANDY_TITLE_MODS);
    private final Component lan = ComponentBackport.translatable(LangUtil.Vanilla.MENU_LAN);
    private final Component stats = ComponentBackport.translatable(LangUtil.Vanilla.GUI_STATS);
    private final Component options = ComponentBackport.translatable(LangUtil.Vanilla.MENU_OPTIONS);
    private final Component disconnect = ComponentBackport.translatable(LangUtil.Vanilla.MENU_DISCONNECT);
    private final Component toUpperBack = ComponentBackport.translatable(LangUtil.Vanilla.MENU_RETURN_TO_GAME);
    private final Component toLowerBack = ComponentBackport.translatable(LangUtil.Gui.PAUSE_RETURN_LOWER);
    private final Component achievements = ComponentBackport.translatable(LangUtil.Gui.PAUSE_ACHIEVEMENTS);
    ...
    protected void init()
    {
        ((ScreenAccessor) this).NT$setTitle(ComponentBackport.translatable(getPauseTitle()));
        this.setLayout();
    }
    ...
    private Component getSave(boolean isLower)
    {
        ...
        return this.isMultiplayer() ? this.disconnect : ComponentBackport.translatable(isLower ? lower : upper);
    }
    ...
    private void saveOrQuit(Button button)
    {
        ...
        if (isLocalServer)
            this.minecraft.clearLevel(new GenericDirtMessageScreen(ComponentBackport.translatable(LangUtil.Vanilla.SAVE_LEVEL)));
        else
    ...
    {
        Component advance = ComponentBackport.translatable(LangUtil.Vanilla.GUI_ADVANCEMENTS);
