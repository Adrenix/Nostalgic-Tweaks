...
public abstract class ClientEventHelper
{
    ...
    public static void classicProgressScreen(Screen screen, SetScreen setScreen)
    {
        ...
        {
            Component title = ComponentBackport.translatable(LangUtil.Gui.LEVEL_LOADING);
            Component subtitle = ComponentBackport.translatable(LangUtil.Gui.LEVEL_BUILDING);
        ...
        if (ClientEventHelper.isLoadingScreen(screen))
        {
            ...
            else
            {
                ...
                else if (screen.getClass() == ReceivingLevelScreen.class)
                {
                    ...
                    progressScreen.setStage(ComponentBackport.translatable(LangUtil.Gui.LEVEL_SIMULATE));
