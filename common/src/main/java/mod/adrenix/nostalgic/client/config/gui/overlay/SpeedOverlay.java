...
public class SpeedOverlay extends ListScreenOverlay<SpeedOverlay.WidgetProvider>
{
    ...
    public SpeedOverlay()
    {
        super(Component.translatable(LangUtil.Gui.OVERLAY_SWING), OVERLAY_WIDTH, OVERLAY_HEIGHT);
    ...
    protected class WidgetProvider extends AbstractWidgetProvider
    {
        ...
        private TextWidget createOldSpeedText()
        {
            ...
            (
                Component.translatable(LangUtil.Gui.OVERLAY_SWING_OLD, DefaultConfig.Swing.OLD_SPEED),
                TextAlign.LEFT,
                this.getStartX(),
                this.getStartY(),
        ...
        private TextWidget createModernSpeedText()
        {
            return new TextWidget
            (
                Component.translatable(LangUtil.Gui.OVERLAY_SWING_MODERN, DefaultConfig.Swing.NEW_SPEED),
                TextAlign.LEFT,
                this.getStartX(),
        ...
        private TextWidget createPhotosensitiveText()
        {
            return new TextWidget
            (
                Component.translatable(LangUtil.Gui.OVERLAY_SWING_PHOTOSENSITIVE, DefaultConfig.Swing.PHOTOSENSITIVE),
                TextAlign.LEFT,
                this.getStartX(),
