...
public class TextGroup extends AbstractWidget
{
    ...
    {
        super(ConfigRowList.TEXT_START, 0, getListWidth(), 12, ComponentBackport.empty());
    ...
    public ArrayList<ConfigRowList.Row> generate()
    {
        ...
        this.label = MultiLineLabel.create(Minecraft.getInstance().font, ComponentBackport.literal(fix), this.width);
    ...
    public class TextRow extends AbstractWidget
    {
        ...
        {
            super(ConfigRowList.TEXT_START, 0, TextGroup.this.width, ConfigRowList.BUTTON_HEIGHT, ComponentBackport.empty());
