...
public abstract class ListScreen extends ConfigScreen
{
    ...
    )
    {
        ...
        if (rows.size() == 0)
        {
            Component translate = ComponentBackport.translatable(langKey);
            Component text = ComponentBackport.literal(ChatFormatting.RED + translate.getString());
    ...
    private void generateContainers()
    {
        ...
        (
            ComponentBackport.translatable(LangUtil.Gui.LIST_HELP_TITLE),
        ...
        (
            ComponentBackport.translatable(LangUtil.Gui.LIST_SAVED_ITEMS),
            this::getSavedRows,
        ...
        (
            ComponentBackport.translatable(LangUtil.Gui.LIST_DEFAULT_ITEMS),
        ...
        (
            ComponentBackport.translatable(LangUtil.Gui.LIST_SELECTABLE_ITEMS),
    ...
    {
        return new TextGroup(ComponentBackport.translatable(LangUtil.Gui.LIST_TUTORIAL)).generate();
    }
    ...
    {
        Component title = ComponentBackport.translatable(LangUtil.Gui.BUTTON_MANAGE_DEFAULTS);
