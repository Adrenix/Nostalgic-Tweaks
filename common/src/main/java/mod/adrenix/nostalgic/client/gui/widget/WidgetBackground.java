 ...
 *
 * @param background  A {@link GuiSprite} for the widget's background.
 * @param disabled    A {@link GuiSprite} for the widget's disabled background.
 * @param highlighted A {@link GuiSprite} for the widget's highlighted background.
 */
public record WidgetBackground(GuiSprite background, GuiSprite highlighted, GuiSprite disabled)
{
    /* Static */
     ...
     * @return A sprite {@link GuiSprite} instance.
     */
    public GuiSprite get(boolean isActive, boolean isHoveredOrFocused)
    {
     ...
     * @return A sprite {@link GuiSprite} instance.
     */
    public GuiSprite get(DynamicWidget<?, ?> widget)
    {
     ...
     * @return A sprite {@link GuiSprite} instance.
     */
    public GuiSprite get(AbstractWidget widget)
    {
        return this.get(widget.isActive(), widget.isHoveredOrFocused());
    }
     ...
     */
    @PublicAPI
    public void render(GuiGraphics graphics, GuiSprite sprite, int x, int y, int width, int height)
    {
