...
public record ConfigRenderer(ConfigScreen parent)
{
    ...
    private void addGeneral()
    {
        ...
        if (NostalgicTweaks.getConnection().isPresent() && NetUtil.isPlayerOp() && !NetUtil.isSingleplayer())
            list.addRow(new ConfigRowBuild.SingleCenteredRow(new ControlButton(ComponentBackport.translatable(LangUtil.Gui.SSO_BUTTON), (button) -> new ServerSideModeOverlay())).generate());
