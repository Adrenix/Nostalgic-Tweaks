...
public record ConfigRenderer(ConfigScreen parent)
{
    ...
    private static ConfigRowGroup.ContainerRow getEmbedded(TweakEmbed embedded, ConfigRowList list)
    {
        ...
        (
            ComponentBackport.translatable(embedded.getLangKey()),
    ...
    private static ConfigRowGroup.ContainerRow getSubcategory(TweakSubcategory subcategory, ConfigRowList list)
    {
        return new ConfigRowGroup.ContainerRow
        (
            ComponentBackport.translatable(subcategory.getLangKey()),
    ...
    private static ConfigRowGroup.ContainerRow getCategory(TweakCategory category, ConfigRowList list)
    {
        return new ConfigRowGroup.ContainerRow
        (
            ComponentBackport.translatable(category.getLangKey()),
    ...
    {
        TextGroup help = new TextGroup(ComponentBackport.translatable(LangUtil.Gui.GENERAL_OVERRIDE_HELP));
        ...
        ControlButton disableAll = new ControlButton(ComponentBackport.translatable(LangUtil.Gui.GENERAL_OVERRIDE_DISABLE), onDisable);
        ControlButton enableAll = new ControlButton(ComponentBackport.translatable(LangUtil.Gui.GENERAL_OVERRIDE_ENABLE), onEnable);
        ControlButton reviewAll = new ControlButton(ComponentBackport.translatable(LangUtil.Gui.GENERAL_OVERRIDE_REVIEW), onReview);

        ToggleCheckbox toggleClientOnly = new ToggleCheckbox
        (
            ComponentBackport.translatable(LangUtil.Gui.GENERAL_OVERRIDE_CLIENT),
            clientOnly::get,
            clientOnly::set
        );
        ...
        (
            ComponentBackport.translatable(LangUtil.Gui.GENERAL_OVERRIDE_SERVER),
            serverOnly::get,
            serverOnly::set
        );

        toggleClientOnly.setTooltip(ComponentBackport.translatable(LangUtil.Gui.GENERAL_OVERRIDE_CLIENT_TIP));
        toggleServerOnly.setTooltip(ComponentBackport.translatable(LangUtil.Gui.GENERAL_OVERRIDE_SERVER_TIP));
    ...
    private ArrayList<ConfigRowList.Row> getConfigManagementList()
    {
        ...
        ControlButton backup = new ControlButton(ComponentBackport.translatable(LangUtil.Gui.GENERAL_MANAGEMENT_BACKUP), onBackup);
        ControlButton open = new ControlButton(ComponentBackport.translatable(LangUtil.Gui.GENERAL_MANAGEMENT_OPEN), onOpen);

        TextGroup groupHelp = new TextGroup(ComponentBackport.translatable(LangUtil.Gui.GENERAL_MANAGEMENT_HELP));
        TextGroup maxHelp = new TextGroup(ComponentBackport.translatable(LangUtil.Gui.GENERAL_MANAGEMENT_MAX_HELP));
    ...
    private ArrayList<ConfigRowList.Row> getGeneralSettingsList()
    {
        ...
        Supplier<ArrayList<ConfigRowList.Row>> getScreenOptions = () ->
        {
            ...
            TextGroup radioHelp = new TextGroup(ComponentBackport.translatable(LangUtil.Gui.GENERAL_CONFIG_SCREEN_INFO));
        ...
        (
            ComponentBackport.translatable(LangUtil.Gui.GENERAL_CONFIG_SCREEN_TITLE),
            getScreenOptions,
        ...
        {
            TextGroup treeHelp = new TextGroup(ComponentBackport.translatable(LangUtil.Gui.GENERAL_CONFIG_TREE_INFO));
        ...
        (
            ComponentBackport.translatable(LangUtil.Gui.GENERAL_CONFIG_TREE_TITLE),
            getTreeOptions,
        ...
        {
            TextGroup rowHelp = new TextGroup(ComponentBackport.translatable(LangUtil.Gui.GENERAL_CONFIG_ROW_INFO));
        ...
        (
            ComponentBackport.translatable(LangUtil.Gui.GENERAL_CONFIG_ROW_TITLE),
            getHighlightOptions,
        ...
        {
            TextGroup tagHelp = new TextGroup(ComponentBackport.translatable(LangUtil.Gui.GENERAL_CONFIG_TAGS_INFO));
            ...
            (
                ComponentBackport.translatable(LangUtil.Gui.GENERAL_CONFIG_NEW_TAGS_LABEL),
            ...
            (
                ComponentBackport.translatable(LangUtil.Gui.GENERAL_CONFIG_SIDED_TAGS_LABEL),
            ...
            (
                ComponentBackport.translatable(LangUtil.Gui.GENERAL_CONFIG_TAG_TOOLTIPS_LABEL),
            ...
            TextGroup statusHelp = new TextGroup(ComponentBackport.translatable(LangUtil.Gui.GENERAL_CONFIG_TWEAK_STATUS_HELP));
            ...
            (
                ComponentBackport.translatable(LangUtil.Gui.GENERAL_CONFIG_TWEAK_STATUS_LABEL),
        ...
        (
            ComponentBackport.translatable(LangUtil.Gui.GENERAL_CONFIG_TAGS_TITLE),
            getTaggingOptions,
    ...
    {
        TextGroup notify = new TextGroup(ComponentBackport.translatable(LangUtil.Gui.GENERAL_NOTIFY_CONFLICT, TweakClientCache.getConflicts()));
    ...
    {
        Component help = ComponentBackport.translatable(LangUtil.Gui.GENERAL_SEARCH_HELP);
        Component newTag = ComponentBackport.translatable(LangUtil.Gui.GENERAL_SEARCH_NEW);
        Component conflictTag = ComponentBackport.translatable(LangUtil.Gui.GENERAL_SEARCH_CONFLICT);
        Component resetTag = ComponentBackport.translatable(LangUtil.Gui.GENERAL_SEARCH_RESET);
        Component clientTag = ComponentBackport.translatable(LangUtil.Gui.GENERAL_SEARCH_CLIENT);
        Component serverTag = ComponentBackport.translatable(LangUtil.Gui.GENERAL_SEARCH_SERVER);
        Component saveTag = ComponentBackport.translatable(LangUtil.Gui.GENERAL_SEARCH_SAVE);
        Component allTag = ComponentBackport.translatable(LangUtil.Gui.GENERAL_SEARCH_ALL);
    ...
    {
        Component help = ComponentBackport.translatable(LangUtil.Gui.GENERAL_SHORTCUT_HELP);
        Component find = ComponentBackport.translatable(LangUtil.Gui.GENERAL_SHORTCUT_FIND);
        Component save = ComponentBackport.translatable(LangUtil.Gui.GENERAL_SHORTCUT_SAVE);
        Component exit = ComponentBackport.translatable(LangUtil.Gui.GENERAL_SHORTCUT_EXIT);
        Component jump = ComponentBackport.translatable(LangUtil.Gui.GENERAL_SHORTCUT_JUMP);
        Component all = ComponentBackport.translatable(LangUtil.Gui.GENERAL_SHORTCUT_ALL);
        Component group = ComponentBackport.translatable(LangUtil.Gui.GENERAL_SHORTCUT_GROUP);
    ...
    private void addGeneral()
    {
        ...
        (
            ComponentBackport.translatable(LangUtil.Gui.GENERAL_MANAGEMENT_TITLE),
        ...
        (
            ComponentBackport.translatable(LangUtil.Gui.GENERAL_OVERRIDE_TITLE),
        ...
        (
            ComponentBackport.translatable(LangUtil.Gui.GENERAL_BINDINGS),
        ...
        (
            ComponentBackport.translatable(LangUtil.Gui.GENERAL_CONFIG_TITLE),
        ...
        (
            ComponentBackport.translatable(LangUtil.Gui.GENERAL_NOTIFY_TITLE),
        ...
        (
            ComponentBackport.translatable(LangUtil.Gui.GENERAL_SEARCH_TITLE),
        ...
        (
            ComponentBackport.translatable(LangUtil.Gui.GENERAL_SHORTCUT_TITLE),
    ...
    public void generateAndRender(PoseStack poseStack, int mouseX, int mouseY, float partialTick)
    {
        if (this.parent.getConfigTab() == ConfigScreen.ConfigTab.SWING)
        {
            ...
            (
                ComponentBackport.translatable(LangUtil.Gui.LEFT_SPEEDS),
            ...
            (
                ComponentBackport.translatable(LangUtil.Gui.RIGHT_SPEEDS),
        ...
        else if (this.parent.getConfigTab() == ConfigScreen.ConfigTab.SEARCH && this.parent.search.isEmpty())
        {
            ...
            if (isInvalidTag)
                ...
                (
                    poseStack,
                    this.parent.getFont(),
                    ComponentBackport.translatable(LangUtil.Gui.SEARCH_INVALID, this.parent.getWidgets().getSearchInput().getValue()),
                    this.parent.width / 2,
            ...
            else
            {
                ...
                (
                    poseStack,
                    this.parent.getFont(),
                    ComponentBackport.translatable(LangUtil.Gui.SEARCH_EMPTY),
                    this.parent.width / 2,
                    this.parent.height / 2,
                    0xFFFFFF
                ));
