...
public class DefaultEntriesOverlay extends ListScreenOverlay<DefaultEntriesOverlay.WidgetProvider>
{
    ...
    {
        super(ComponentBackport.translatable(LangUtil.Gui.OVERLAY_DEFAULTS), OVERLAY_WIDTH, OVERLAY_HEIGHT);
    ...
    protected class WidgetProvider extends AbstractWidgetProvider
    {
        ...
        {
            String translation = ComponentBackport.translatable(LangUtil.Gui.OVERLAY_DEFAULTS_HEADER).getString();
        ...
        private TextWidget createMessageText()
        {
            return new TextWidget
            (
                ComponentBackport.translatable(LangUtil.Gui.OVERLAY_DEFAULTS_MESSAGE),
                TextAlign.LEFT,
                this.getStartX(),
        ...
        private Button createEnableAll()
        {
            ...
            (
                ...
                ComponentBackport.translatable(LangUtil.Gui.BUTTON_ENABLE_ALL),
                (button) ->
                {
                    Overlay.close();
        ...
        private Button createDisableAll()
        {
            ...
            (
                ...
                this.getButtonWidth(),
                SettingsScreen.BUTTON_HEIGHT,
                ComponentBackport.translatable(LangUtil.Gui.BUTTON_DISABLE_ALL),
                (button) ->
                {
                    Overlay.close();
