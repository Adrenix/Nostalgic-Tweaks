...
public class ItemSuggestionHelper
{
    ...
    public Item getItem()
    {
        ...
        try
        {
            item = ItemParser.parseForItem(HolderLookup.forRegistry(Registry.ITEM), new StringReader(this.input.getValue())).item().value();
        }
    ...
    public void updateItemSuggestions()
    {
        ...
        this.pendingSuggestions = ItemParser.fillSuggestions(HolderLookup.forRegistry(Registry.ITEM), builder, false);
