...
public class RemoveButton extends Button
{
    ...
    private static final Component DISABLE_TITLE = ComponentBackport.translatable(LangUtil.Gui.BUTTON_DISABLE);
    private static final Component ENABLE_TITLE = ComponentBackport.translatable(LangUtil.Gui.BUTTON_ENABLE);
    private static final Component REMOVE_TITLE = ComponentBackport.translatable(LangUtil.Gui.BUTTON_REMOVE);
