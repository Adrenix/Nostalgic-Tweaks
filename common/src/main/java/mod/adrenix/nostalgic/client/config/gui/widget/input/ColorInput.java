...
public class ColorInput extends AbstractWidget
{
    ...
    public ColorInput(TweakClientCache<String> tweak)
    {
        ...
        super(ConfigRowList.getControlStartX(), 0, ConfigRowList.BUTTON_WIDTH, ConfigRowList.BUTTON_HEIGHT, ComponentBackport.empty());
    ...
    public void render(PoseStack poseStack, int mouseX, int mouseY, float partialTick)
    {
        ...
        if (MathUtil.isWithinBox(mouseX, mouseY, this.x, this.y, 20, 20))
            screen.renderLast.add(() -> screen.renderTooltip(poseStack, ComponentBackport.translatable(LangUtil.Gui.OVERLAY_INPUT_TIP), mouseX, mouseY));
