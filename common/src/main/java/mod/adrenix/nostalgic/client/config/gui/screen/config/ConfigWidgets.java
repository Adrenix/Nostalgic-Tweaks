...
public class ConfigWidgets
{
    ...
    private Button generateListButton()
    {
        ...
        return new OverlapButton(ComponentBackport.empty(), action).setAsList();
    }
    ...
    private Button generateGeneralButton()
    {
        ...
        (
            ComponentBackport.translatable(ConfigScreen.ConfigTab.GENERAL.getLangKey()),
    ...
    private Button generateSoundButton()
    {
        return new OverlapButton
        (
            ComponentBackport.translatable(ConfigScreen.ConfigTab.SOUND.getLangKey()),
    ...
    private Button generateCandyButton()
    {
        return new OverlapButton
        (
            ComponentBackport.translatable(ConfigScreen.ConfigTab.CANDY.getLangKey()),
    ...
    private Button generateGameplayButton()
    {
        return new OverlapButton
        (
            ComponentBackport.translatable(ConfigScreen.ConfigTab.GAMEPLAY.getLangKey()),
    ...
    private Button generateAnimationButton()
    {
        return new OverlapButton
        (
            ComponentBackport.translatable(ConfigScreen.ConfigTab.ANIMATION.getLangKey()),
    ...
    private Button generateSwingButton()
    {
        return new OverlapButton
        (
            ComponentBackport.translatable(ConfigScreen.ConfigTab.SWING.getLangKey()),
    ...
    {
        Component translation = ComponentBackport.translatable(ConfigScreen.ConfigTab.SEARCH.getLangKey());
        Component title = ComponentBackport.literal("    " + translation.getString());
    ...
    private Button generateCancelButton()
    {
        ...
        (
            ...
            getSmallWidth(),
            BUTTON_HEIGHT,
            ComponentBackport.translatable(LangUtil.Vanilla.GUI_CANCEL),
    ...
    private Button generateSaveButton()
    {
        ...
        (
            ...
            getSmallWidth(),
            BUTTON_HEIGHT,
            ComponentBackport.translatable(LangUtil.Gui.BUTTON_SAVE_AND_DONE),
    ...
    private EditBox generateInputBox()
    {
        ...
        Component title = ComponentBackport.translatable(LangUtil.Vanilla.SEARCH).withStyle(ChatFormatting.ITALIC);
    ...
    {
        return new TextGroup(ComponentBackport.translatable(LangUtil.Gui.SETTINGS_SPEED_HELP));
    }
    ...
    {
        return ComponentBackport.translatable(tweak.getRelatedKey()).getString().toLowerCase().trim().split(" *, *");
    }
