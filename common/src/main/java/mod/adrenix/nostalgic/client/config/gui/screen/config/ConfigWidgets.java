...
public class ConfigWidgets
{
    ...
    {
        Component title = Component.translatable(ConfigScreen.ConfigTab.GENERAL.getLangKey());
        return new Button
        (
            0,
            TOP_ROW,
    ...
    {
        Component title = Component.translatable(ConfigScreen.ConfigTab.SOUND.getLangKey());
        return new Button
        (
            0,
            TOP_ROW,
    ...
    {
        Component title = Component.translatable(ConfigScreen.ConfigTab.CANDY.getLangKey());
        return new Button
        (
            0,
            TOP_ROW,
    ...
    {
        Component title = Component.translatable(ConfigScreen.ConfigTab.ANIMATION.getLangKey());
        return new Button
        (
            0,
            TOP_ROW,
    ...
    {
        Component title = Component.translatable(ConfigScreen.ConfigTab.SWING.getLangKey());
        return new Button
        (
            0,
            TOP_ROW,
    ...
    private EditBox generateInputBox()
    {
        ...
        return new EditBox(this.parent.getFont(), x, 4, INPUT_WIDTH, INPUT_HEIGHT, Component.translatable(NostalgicLang.Vanilla.SEARCH).withStyle(ChatFormatting.ITALIC));
    }
    ...
    public void checkSearch(String search)
    {
        ...
        for (TweakClientCache<?> tweak : entries.values())
        {
            ...
            {
                if (Component.translatable(tweak.getLangKey()).getString().toLowerCase().contains(search))
                    this.parent.search.add(tweak);
            }
        }
    }
