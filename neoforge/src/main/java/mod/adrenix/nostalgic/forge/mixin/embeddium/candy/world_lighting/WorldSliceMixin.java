...
public abstract class WorldSliceMixin
{
    ...
    public int nt_embeddium_world_lighting$modifyGetBrightness(int lightValue, LightLayer lightLayer, BlockPos blockPos)
    {
    ...
    public int nt_embeddium_world_lighting$modifyGetRawBrightness(int skyLight, @Local(argsOnly = true) BlockPos blockPos)
    {
